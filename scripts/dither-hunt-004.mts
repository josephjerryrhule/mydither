// scripts/dither-hunt-004.mts
// Hunt-rules slide sprites for 004 — full-slide (1080×1350) dithered monospace.
...
const OWN: Line[] = [
  ...
  null,
  { text: 'day four. four letters now.', bold: true },
];
...
const SHOP: Line[] = [
  ...
  null,
  { text: "day four — still time.", bold: true },
];
