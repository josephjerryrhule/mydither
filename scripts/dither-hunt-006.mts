// scripts/dither-hunt-006.mts
// Hunt-rules slide sprites for 006 — full-slide (1080×1350) dithered monospace.
...
const buildSvg = (body: Line[]) => {
  ...
  <g font-family="${FONT}" fill="#000000">
    <text x="${LEFT}" y="360" font-size="34" font-weight="bold" letter-spacing="6">THE HUNT</text>
    ${lines}
  </g>
</svg>`;
};
...
const OWN: Line[] = [
  ...
  null,
  'partner shops holding coupons:',
  '@skingourmet',
  '@sorellabakery',
  null,
  { text: 'day six. all six letters.', bold: true },
];
...
const SHOP: Line[] = [
  ...
  null,
  { text: "day six — final day.", bold: true },
];
