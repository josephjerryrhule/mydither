// scripts/dither-hunt-005.mts
// Hunt-rules slide sprites for 005 — full-slide (1080×1350) dithered monospace.
...
const OWN: Line[] = [
  ...
  null,
  { text: 'day five. five letters now.', bold: true },
];
...
const SHOP: Line[] = [
  ...
  null,
  { text: "day five — still time.", bold: true },
];
