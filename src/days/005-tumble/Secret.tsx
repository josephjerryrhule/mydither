// src/days/005-tumble/Secret.tsx
// Treasure-hunt glyph T woven into the grain.
  ...
  return (
    <div
      style={{
        ...
        width: size,
        height: size,
        maskImage: `url(${staticFile('005/secret.png')})`,
        WebkitMaskImage: `url(${staticFile('005/secret.png')})`,
        maskSize: '100% 100%',
