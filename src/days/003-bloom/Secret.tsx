// src/days/003-bloom/Secret.tsx
// Treasure-hunt glyph O woven into the grain. Coarser dither (size 5) masked to SVG character.
  ...
  return (
    <div
      style={{
        ...
        width: size,
        height: size,
        maskImage: `url(${staticFile('003/secret.png')})`,
        WebkitMaskImage: `url(${staticFile('003/secret.png')})`,
        maskSize: '100% 100%',
