// src/days/003-bloom/Scene.tsx
import { AbsoluteFill, staticFile, useCurrentFrame, useVideoConfig } from 'remotion';
import label from '../../../public/003/label.json';
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: PALETTE.paper, overflow: 'hidden' }}>
      {/* 
        ...
        Upscaled via CSS pixelated interpolation on print to keep dither texture spacious.
      */}
      <div
        style={{
          position: 'absolute',
