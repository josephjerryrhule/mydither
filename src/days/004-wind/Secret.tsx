// src/days/004-wind/Secret.tsx
// Treasure-hunt glyph W woven into the grain. Coarser dither (size 5) masked to SVG character.
  ...
  return (
    <div
      style={{
        ...
        width: size,
        height: size,
        maskImage: `url(${staticFile('004/secret.png')})`,
        WebkitMaskImage: `url(${staticFile('004/secret.png')})`,
        maskSize: '100% 100%',
